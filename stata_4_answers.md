...
## PART 2
- P.5 When clusters are fixed at 200, I would recommend a cluster size of 8 (ie 2^3) because it achieves power of 90.4%, whereas, clustersize of 4 achieves 75%. Morevoer, power only increases slightly when going to larger cluster size like 2^4 (16), which only provides a relatively small increase (to 97.2%). Using a smaller cluster size is more economical in terms of time and resources which are important considerations in planning a study.  <br />
- P.6 To achieve 80% power, 100 schools (with 15 students each) would be required to detect a 0.2 sd treatment effect in the study. This would give power of 84.2%. <br />
- P.7 200 schools would be needed to achieve 80% power with only 70% takeup of treatment. 200 schools would give a power of 86.6%.
